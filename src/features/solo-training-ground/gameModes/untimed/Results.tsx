...
const UntimedResults: FC = () => {
  ...
  const {
    ...
    totalTime: number;
  } = JSON.parse(atob(resultsEncoded));
      ...
      <MainContent>
        <div className="w-full max-w-4xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-white">No Rush Mastery - Results</h1>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              onClick={() => navigate(`/student/solo-training-ground/untimed?op=${settings.operation}`)}
            >
              Practice Again
            </button>
          </div>
